...
public class JSONObject : Nullable {
	...
	public void AddField(ulong val) { Add(new JSONObject(val)); }
	...
	public void AddField(string name, ulong val) { AddField(name, new JSONObject(val)); }
