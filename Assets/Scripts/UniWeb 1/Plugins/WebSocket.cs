...
{   
    public class WebSocket
    {
        ...
        IEnumerator _Connect (Uri uri)
        {
			...
			req.headers.Set("Sec-WebSocket-Extensions", "permessage-deflate, client_max_window_bits");
            //req.headers.Add ("Sec-WebSocket-Protocol", "chat, superchat");
            req.headers.Set ("Sec-WebSocket-Version", "13");
			req.headers.Set ("Origin", "http://www.websocket.org");
			req.headers.Set ("Host", "runner.staging.mossapi.com:8080");
