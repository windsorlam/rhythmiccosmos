...
namespace HTTP.SocketIO
{
    public class SocketIOConnection : MonoBehaviour
    {
        ...
        {
			Debug.Log("----> [SocketIOConnection Send]");
        ...
        {
			Debug.Log("----> [SocketIOConnection Emit]");
            var m = new SocketIOMessage ();
        ...
        {
			Debug.Log("----> [SocketIOConnection EstablishConnection]");
        ...
        {
			Debug.Log("----> [SocketIOConnection Dispatch]");
        ...
        {
			Debug.Log("----> [SocketIOConnection HandleSocketOnTextMessageRecv]");
        ...
        {
			Debug.Log("----> [SocketIOConnection Heartbeat]");
